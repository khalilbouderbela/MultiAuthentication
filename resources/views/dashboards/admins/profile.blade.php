            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#users_list" data-toggle="tab">Users List</a></li>
              ...
              <div class="card-body">
                ...
                <div class="active tab-pane" id="users_list">
                  <table class="table">
                    <thead>
                      <tr>
                        <th scope="col"></th>
                  ...
                  @foreach ($user as $users)
                   ...
                   <tr>
                          ...
                          <td>{{ $users->name }}</td>
                            <td>{{ $users->email }}</td>
                            <td>{{ $users->phone }}</td>
                       <td>{{ $users->role == 2 ? "User" : "Manager"}}</td>
                     <td>
                    <a href="{{ route('adminEditUser',$users->id) }}" class="btn btn-primary btn-sm" style="background-color: #36C95D">Edit</a>
                    </td>
                      <td>
                      <a class="btn btn-primary btn-sm" href="{{ route('delete-user',$users->id) }}" style="background-color: #BF1E2B">Delete</a>
                       </td>
                       </tr>
                       @endforeach
                     </tbody>
      ...
      <td>
        ...
        @else
          ...
          @endif
                     ...
                     <td>
                    <a class="btn btn-primary btn-sm" href="{{ route('project.ViewUpdateAdmin',$projects->id) }}" style="background-color: #36C95D">Edit</a>
                    </td>
                      <td>
                      <a class="btn btn-primary btn-sm" href="{{ route('delete-project-admin',$projects->id) }}" style="background-color: #BF1E2B">Delete</a>
                       </td>
                       </tr>
                       @endforeach
                     </tbody>
